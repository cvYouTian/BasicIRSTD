...
parser.add_argument("--dataset_dir", default='/home/youtian/Documents/pro/pyCode/BasicIRSTD/datasets', type=str, help="train_dataset_dir")
    ...
    for idx_epoch in range(epoch_state, opt.nEpochs):
        ...
        for idx_iter, (img, gt_mask) in enumerate(tbar):
            ...
            tbar.set_description("Epoch:%3d, lr:%f, train loss:%f"%(
                idx_epoch, optimizer.param_groups[0]["lr"], np.mean(losses)))
